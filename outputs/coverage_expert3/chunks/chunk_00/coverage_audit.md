...
| V3 delete_hole | 458 | 458 | 100.0% | 0 |
...
| Reason | Count |
|---|---:|
| `skipped_no_delete_candidate` | 1998 |
...
| `delete_skipped_no_delete_candidate` | 1998 |
| `delete_skipped_unsupported_hole_context` | 461 |
| `skipped_batch_hole` | 458 |
...
Sample JSONL: `outputs\coverage_expert3\chunks\chunk_00\preview_samples.jsonl`
Gallery: `outputs\coverage_expert3\chunks\chunk_00\preview_gallery\index.html`
